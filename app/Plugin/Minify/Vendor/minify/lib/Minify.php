...
class Minify {
    ...
    protected static function _combineMinify()
    {
        ...
        $imgUrl = FULL_BASE_URL . Router::getRequest()->webroot;
        $controller = new Controller();
        $controller->getEventManager()->dispatch(new CakeEvent('Plugin.Minify.beforeReplaceImgUrl', self,array(
        	'imgUrl' => &$imgUrl
        )));
        ...
        if (isset($matches['0'])){
            foreach ($matches['0'] as $item){
                ...
                $content = str_replace($item, $replace_url, $content);
            }
        }
        // end MOOSOCIAL-2836
