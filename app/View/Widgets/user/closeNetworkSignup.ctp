...
<div <?php if($this->getPageId() == 'page_guest_home-index'): ?>class="user_register_holder"<?php endif; ?>>
    ...
    if ( ( empty($uid)) ):
        ...
        <div class="bar-content user_register_form">
            ...
            <div id="signUpForm" class="row">
                ...
                <?php endif;?>
                 <?php $this->getEventManager()->dispatch(new CakeEvent('View.SocialLogin.Elements', $this)); ?>
            </div>
            <?php endif;?>
        </div>
    <?php endif; ?>
