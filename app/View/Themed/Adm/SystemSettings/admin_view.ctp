...
<?php endif; ?>
<?php if(in_array(Configure::read('core.production_mode'),array(1,2))):?>
<a href="<?php echo $this->request->base?>/admin/system_settings/create" class="btn green btn_create_theme">
    <i class="fa fa-plus"></i> <?php echo  __('Create New Setting');?>
</a>
<?php endif;?>
	                    ...
	                    <div class="tab-content">
	                        <div class="tab-pane active" id="portlet_tab1">
	                            ...
	                            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo $this->request->base?>/admin/system_settings/quick_save">
	                                ...
	                                ?>
	                                    <?php if($setting['name'] != 'logo' && $setting['name'] != 'og_image' ):?>
