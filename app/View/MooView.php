...
class MooView extends View
{
    ...
    public function renderContent(){
        ...
        if($this->manualLoadingLayout){
            ...
            $content = $this->_evaluate($viewFile,array('content'=>$content));
    ...
    public function renderComment($params = array())
    {
    	...
    	return $this->element('comments_widget',array_merge($params,array('check_see_status'=>$check_see_status,'check_post_status'=>$check_post_status,'subject'=>$subject,'data'=>$data,'params'=>$params)));
    }
