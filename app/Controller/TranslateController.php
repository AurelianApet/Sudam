...
class TranslateController extends AppController {
	...
	{
		$values = $this->loadPo('C:\Tung\Job\Socialloft\2.3.2\app\Locale\eng\LC_MESSAGES\default.pot');
		$values1 = $this->loadPo('C:\Tung\Job\Socialloft\2.3.2\app\Locale\eng\LC_MESSAGES\default.po');
